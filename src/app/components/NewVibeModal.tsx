              ...
              <div className="relative shrink-0 w-full">
                ...
                <div className="flex flex-row items-center size-full">
                  <div className="content-stretch flex items-center justify-between relative w-full p-[20px]">
                    ...
                    <p className="font-['Geist_Mono',monospace] font-bold leading-[1.1] relative shrink-0QX text-[#b2b2b2] text-[20px] text-nowrap uppercase tracking-wider">new vibe</p>
                  </div>
                </div>
              </div>
                      ...
                      <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                        ...
                        <div className="content-stretch flex gap-[12px] items-start relative shrink-0 w-full">
                          ...
                          >
                            ...
                            <div className="flex flex-row items-center justify-center size-full">
                              <div className="content-stretch flex gap-[8px] items-center justify-center p-[16px] relative w-full">
                                <p className="basis-0 font-['Geist_Mono',monospace] font-normal grow leading-[1.1] min-h-px min-w-px relative shrink-0 text-[16px] text-black">good vibe</p>
                          ...
                          >
                            ...
                            <div className="flex flex-row items-center justify-center size-full">
                              <div className="content-stretch flex gap-[8px] items-center justify-center p-[16px] relative w-full">
                                <p className="basis-0 font-['Geist_Mono',monospace] font-normal grow leading-[1.1] min-h-px min-w-px relative shrink-0 text-[#6f6f6f] text-[16px]">mid vibe</p>
                          ...
                          >
                            ...
                            <div className="flex flex-row items-center justify-center size-full">
                              <div className="content-stretch flex gap-[8px] items-center justify-center p-[16px] relative w-full">
                                <p className="basis-0 font-['Geist_Mono',monospace] font-normal grow leading-[1.1] min-h-px min-w-px relative shrink-0 text-[#6f6f6f] text-[16px]">bad vibe</p>
