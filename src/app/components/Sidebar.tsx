    ...
    <div className="flex flex-col w-[300px] shrink-0 h-full bg-[rgba(255,255,255,0.05)] border-r border-[rgba(255,255,255,0.2)] border-dashed">
      ...
      <div className="flex flex-col w-full shrink-0">
        ...
        <div className="w-full bg-[rgba(255,255,255,0.05)] border-b border-[rgba(255,255,255,0.2)] border-dashed">
          <button 
            onClick={onAddOrg}
            className="flex items-center justify-between p-3 cursor-pointer hover:bg-white/10 transition-colors w-full text-left"
          ...
          {!isSearchMode ? (
            ...
            <div className="flex items-center justify-between p-3">
              <input
                ...
                className="flex-1 bg-transparent border-none outline-none font-['Audiowide',sans-serif] text-[16px] text-white placeholder:text-[rgba(255,255,255,0.2)] w-full"
              />
              <button
